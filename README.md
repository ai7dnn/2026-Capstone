...
- 개인과제와 팀과제을 수행
  - [개인별과제]: 프로젝트아이디어제안서(5), 자기주도학습: 본 수업의 자기주도학습을 깃허브에 보고(5) **[2026/6/6(토) 마감]**
  - [팀별과제]: 팀프로젝트아이디어제안서(5), 프로젝트기획서(5), 프로젝트중간보고서(10), 프로젝트최종보고서(10), 팀내 프로젝트 개인참여 학생 및 교수 평가(10)

## 2026.6.2 최종 발표 내용: 발표시간은 20-30분
- 목차로는 다음 위주의 발표
  - (4. UI/UX 설계)
  - (5. 프로젝트 진행 최종 결과)
- 팀 깃허브 활용 및 저장소 내용 소개
  - 회의록 정리
- 프로토타입 데모

## 중간, 기말고사
- 4/21화 오후 2:00 ~ 2:50(6교시) 2-109-1호(수업 실습실)
- 6/16화 오후 2:00 ~ 2:50(6교시) 2-109-1호(수업 실습실) 
...
- 팀 프로젝트기획서 발표 11주 2026-5-12(화)
- 팀 프로젝트중간보고서(최종보고서 3까지) 발표 13주 2026-5-26(화)
...
- **2.6 LLM 활용**    
  커서와 클로드 등 LLM 활용, chatGPT와 클로드 등 API 키 활용 
...
- **유사 서비스/선행 연구 비교**: 유사한 기존 서비스나 관련 연구를 조사·분석하여 차별점과 독창성 제시
- **주제 관련 기술 개요**: ChatGPT, API, LLM, 프롬프트 설계 등 주요 기술 개요
- **LLM 활용 계획**: 커서와 클로드 등 LLM 활용, chatGPT와 클로드 등 API 키 활용 계획
...
- **LLM 활용 결과**: 커서와 클로드 등 LLM 활용, chatGPT와 클로드 등 API 키 활용 결과
- **성과물 소개**: 현재까지 완성된 기능, 문서, 화면 설계, 코드 일부 등
- **프로토타입 실행**: 다양한 도구를 사용하여 현재까지 완성된 프로토타입 실행
